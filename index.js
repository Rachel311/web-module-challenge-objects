...
*/
  ...
  createMenuItem("Pizzas", 5, "Lunch");
  createMenuItem("Doughnuts",  4, "Breakfast");
  createMenuItem("Salads", 6, "Lunch");
...
export const burger = {
  ...
  category: "Lunch", 
  discount: function (){
    const teacher = this.price*0.25 
    return this.price-teacher
    }
} 
...
*/
reviews.push ({name: "Asher", rating: 7, feedback: "Loved the food, but would really come back for the ambiance!"})
console.log(reviews)
